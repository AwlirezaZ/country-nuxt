     ...
     <div class="flex h-full">
        <div class="bg-gray-300 w-1/3 ">
           <div class="flex justify-center h-full items-center">
             <div class="justify-center" @click="timerCountUp()">
        ...
        <div class="bg-white w-2/3">
          ...
          <div class="w-full py-200 h-1/3 my-12 ">
            
            <div class="w-1/2 py-1 mx-auto">
              <h1 class="text-lg">NEW TASK</h1>
              <input class="block w-full my-10 h-12 border-2 border-black" type="text" placeholder="name" />
              <input class="block w-full my-10 h-12 border-2 border-black" type="text" placeholder="email"/>
              <button class="block w-full my-10 h-12 border-2 border-black bg-black rounded-lg"><span class="text-white">START</span></button>
              <button class="block w-full my-10 h-12 border-2 bg-gray-300 rounded-lg" ><span class="text-color">CANCEL</span></button>
